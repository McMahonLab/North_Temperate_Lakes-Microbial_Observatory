...
```{r, Evenness between bogs, echo=FALSE}
...
ggplot(data = epi.data, aes(y = epi.evenness, x = epi.lakes, fill = epi.lakes)) + geom_boxplot() + labs(y = "Observed Richness", x = NULL) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.text.x = element_text(hjust = 1, size = 16, colour = "black"), axis.title = element_text(size = 18, vjust = 2), axis.text.y = element_text(colour = "black", size = 14), legend.position = "none") + scale_fill_brewer(palette = "Set3")

ggplot(data = hypo.data, aes(y = hypo.evenness, x = hypo.lakes, fill = epi.lakes)) + geom_boxplot() + labs(y = "Observed Richness", x = NULL) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.text.x = element_text(hjust = 1, size = 16, colour = "black"), axis.title = element_text(size = 18, vjust = 2), axis.text.y = element_text(colour = "black", size = 14), legend.position = "none") + scale_fill_brewer(palette = "Set3") 
...
```
####Figure S1. Evenness between bogs
***
```{r, Evenness between bogs, echo=FALSE}
...
```
####Figure S6. Connectivity between bogs
***

```{r, hclust of all bogs, echo=FALSE}

```
####Figure S7. hclust of all bogs
***
